...
ser = serial.Serial("/dev/tty.usbserial-0232B13B", 230400, timeout=120)
...
ax.set_ylabel("Accelerations (G's)")
fig.canvas.manager.set_window_title("Plot Acceleration Data [-3 to 3 G's]")
fig.tight_layout()
plt.show()